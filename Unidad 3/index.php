...
<head>
    ...
    <meta name="Martinez Contreras" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 173 7704</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i>Angelmtz1428@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-8">
						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="agregarproductos.php" target="_blank"><i
...
-<h4 class="panel-title"><a href="#">Caballeros</a></
h4>
